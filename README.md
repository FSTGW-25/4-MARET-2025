...
<body>
  <div class="title-box">13 Hari Lagi Kak Thania Theresia Podung Ulang Tahun! 🎉🎂🥳</div>
  ...
  <div id="photo-gallery" class="photo-gallery" style="display: none;">
    <div class="gallery-container">
      <img src="foto 16.jpeg" class="gallery-photo">
    </div>
  </div>

  <script>
    const audio = new Audio('Seventeen-Game Boy.mp3');
    ...
    const fullMessage = `Hidup adalah perjalanan yang penuh dengan tantangan dan kejutan 🌻, tetapi justru di sanalah keindahannya 🌈. Tidak perlu terburu-buru atau takut gagal 🌼, karena setiap langkah yang diambil memiliki makna 🤍. Ada kalanya jalan terasa mudah ✨, ada kalanya penuh liku 🌿, tetapi semua itu adalah bagian dari proses yang membentuk diri menjadi lebih kuat 🌷. Seperti hujan yang mendahului pelangi 🌈, setiap kesulitan yang dihadapi akan membawa keindahan pada waktunya 🌻. Jangan ragu untuk terus melangkah 🚀, sebab dunia ini luas dan penuh kemungkinan yang menanti untuk ditemukan 🤍. Pelangi tidak hanya terdiri dari satu warna 🌈, tetapi memiliki banyak corak yang berpadu membentuk keindahan 🌼. Begitu pula dengan kehidupan—setiap pengalaman, baik suka maupun duka 🌷, adalah bagian dari kisah yang menjadikannya lebih berarti 🤍. Jangan hanya terpaku pada satu warna atau satu bagian dari perjalanan 🌿, karena setiap momen, sekecil apa pun, memiliki perannya sendiri ✨. Hargai setiap proses 🌻, nikmati setiap tantangan 🚀, dan percayalah bahwa pada akhirnya, semua warna yang dilewati akan membentuk cerita yang indah dan penuh makna 🤍.`;
